    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            The Eazyteach website contains documents and resources contributed
          ...
          <p className="mb-4">
            ...
            While we strive to ensure accuracy and currency, Eazyteach does not
            guarantee the reliability or authenticity of third-party
            information. Eazyteach disclaims any liability for actions taken
            based on the information presented, as well as any consequences
            arising from such actions.
          </p>
          <p className="mb-4">External Links</p>
          <p className="mb-4">
            Eazyteach’s web portal may feature links to external websites
            ...
            not imply endorsement of the external site or its content. Eazyteach
            may remove or update links at any time without prior notice.
          </p>
          <p className="font-semibold mb-2">External Links</p>
          <p className="mb-4">
            For concerns about linked external websites, please contact the
            respective organizations. Eazyteach is not responsible for the
          ...
          {/* <p className="mb-4">
            ...
            or authorized by law. Eazyteach reserves the right to determine
